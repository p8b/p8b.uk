...
const Home = () => {
   ...
   useEffect(() => {
      ...
      let msgTimer = setInterval(() => {
         if (counter === msg.length) {
            ...
            setMessage((prevMsg) => prevMsg.replace("_", "") + msg[counter] + "_");
            counter++;
         }
   ...
   return (
      <Container className="custom-container bg-transparent">
         <div className="row">
            <div className="col-12 text-center bg-white pt-4 pb-5">
               <div className="row col-12 justify-content-center mt-5">
                  ...
                  <h2 className="col-12 mt-3" children={message} />
